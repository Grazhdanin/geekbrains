...
class Data:
    ...
    def extract(cls, day_month_year):
        ...
        for i in day_month_year.split():
            if i != '-':
                my_date.append(i)
        day, month, year = int(my_date[0]), int(my_date[1]), int(my_date[2])
        return cls.valid(day, month, year)
...
today = Data('06 - 07 - 2020')
print(today)
print(Data.valid(11, 11, 2022))
print(today.valid(11, 13, 2011))
print(Data.extract('11 - 13 - 2011'))
print(today.extract('44 - 11 - 2020'))
print(today.valid(5, 11, 1994))
